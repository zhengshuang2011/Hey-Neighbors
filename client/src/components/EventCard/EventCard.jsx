  ...
  const Popup = props => {
    return (
      <div className="popup-box">
        <div className="box">
          <span className="close-icon" onClick={props.handleClose}><CancelIcon color="action" /></span>
          {props.content}
        </div>
      </div>
    );
    ...
    if (mask) {
      return (
        <div className="features_m">
          <div className="items__time feature_icon"><MasksIcon /></div>
          <div className="items__time details">Please wear a mark to attend the event</div>
        </div>
      )
    } else {
      return (
    ...
    if (vaccine) {
      return (
        <div className="features_v">
          <div className="items__time feature_icon"><VaccinesIcon /></div>
          <div className="items__time details">Please be vaccined to attend the event</div>
        </div>
      )
    } else {
      return (
