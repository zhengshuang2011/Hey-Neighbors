...
INSERT INTO events (
  host_id, event_name, address, city, province, country, post_code, date, start_at, duration, photo_image, description, category_id, max_people_number, mask, vaccine
)VALUES(
  1, 'baby party', '1170 Yonge St', 'Richmond Hill', 'ON', 'Canada', 'L4E 0K4', '2022-04-30', '16:00:00', 2, 'https://images.pexels.com/photos/1884269/pexels-photo-1884269.jpeg', 'Come to join our baby party', 3, 10, TRUE, TRUE
);
...
INSERT INTO events (
  host_id, event_name, address, city, province, country, post_code, date, start_at, duration, photo_image, description, category_id, max_people_number, mask, vaccine,status_id
)VALUES(
...
INSERT INTO events (
  host_id, event_name, address, street, city, province, country, post_code, locationLatitude, locationLongitude, date, start_at, duration, photo_image, description, category_id, max_people_number, mask, vaccine, status_id
)VALUES(
